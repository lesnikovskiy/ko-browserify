...
},{"signals":4}],4:[function(require,module,exports){
...
var _sportsList = require("./components/sports-list/sports-list");

var _sportsList2 = _interopRequireDefault(_sportsList);
...
_knockout2.default.components.register("hello-world", _helloWorld2.default);
_knockout2.default.components.register("discount-widget", _discountWidget2.default);
_knockout2.default.components.register("sports-list", _sportsList2.default);
...
},{"./Router":8,"./components/about-page/about.html":9,"./components/discount-widget/discount-widget":11,"./components/hello-world/hello-world":13,"./components/home-page/home":15,"./components/nav-bar/nav-bar":17,"./components/sports-list/sports-list":20,"knockout":6}],8:[function(require,module,exports){
"use strict";
...
exports.default = new Router({
	routes: [{ url: '', params: { page: 'home-page' } }, { url: 'hello', params: { page: 'hello-world', name: 'Frank Wiermann' } }, { url: 'discount', params: { page: 'discount-widget', logo: 'E-Shop' } }, { url: 'sports-list', params: { page: 'sports-list' } }, { url: 'about', params: { page: 'about-page' } }]
});

},{"crossroads":1,"hasher":3,"knockout":6}],9:[function(require,module,exports){
...
},{"./discount-widget.html":10,"knockout":6}],12:[function(require,module,exports){
...
},{"./hello-world.html":12,"knockout":6}],14:[function(require,module,exports){
...
},{"./nav-bar.html":16,"knockout":6}],18:[function(require,module,exports){
"use strict";
...
var SportItem = function SportItem(params) {
	...
	this.training = _knockout2.default.observable(params.training);
	this.walking = _knockout2.default.observable(params.walking);
};

exports.default = SportItem;

},{"knockout":6}],19:[function(require,module,exports){
module.exports = "<h1>Sport Items</h1>\r\n<table class=\"table\">\r\n\t<thead>\r\n\t\t<tr>\r\n\t\t\t<th>Weight</th>\r\n\t\t\t<th>Date</th>\r\n\t\t\t<th>Training</th>\r\n\t\t\t<th>Walking</th>\r\n\t\t</tr>\r\n\t</thead>\r\n\t<tbody data-bind=\"foreach: sportList\">\r\n\t\t<tr>\r\n\t\t\t<td data-bind=\"text: weight\"></td>\r\n\t\t\t<td data-bind=\"text: date\"></td>\r\n\t\t\t<td data-bind=\"text: training\"></td>\r\n\t\t\t<td data-bind=\"text: walking\"></td>\r\n\t\t</tr>\r\n\t</tbody>\r\n</table>";
...
var _SportItem = require("./SportItem");

var _SportItem2 = _interopRequireDefault(_SportItem);

var _sportsList = require("./sports-list.html");
...
var SportsList = function SportsList() {
	var _this = this;

	_classCallCheck(this, SportsList);

	this.sportList = _knockout2.default.observableArray();
	...
	_jquery2.default.ajax({
		...
		_this.sportList(_knockout2.default.utils.arrayMap(data, function (item) {
			return new _SportItem2.default(item);
		}));
	});
};
...
exports.default = {
	...
	template: _sportsList2.default
};

},{"./SportItem":18,"./sports-list.html":19,"jquery":5,"knockout":6}]},{},[7])